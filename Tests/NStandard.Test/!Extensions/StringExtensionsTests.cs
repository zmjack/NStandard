...
public class StringExtensionsTests
{
    ...
    public void GetLinesTest()
    {
        ...
        Assert.Equal(["1", "2"], $"1{Environment.NewLine}2".GetLines());
        Assert.Equal(["1", "2"], $"1{Environment.NewLine}2{Environment.NewLine}".GetLines());
        Assert.Equal(["1", " "], $"1{Environment.NewLine} ".GetLines());
        Assert.Equal(["", "1", " "], $"{Environment.NewLine}1{Environment.NewLine} ".GetLines());
    ...
    public void GetPureLinesTest()
    {
        ...
        Assert.Equal(["1", "2"], $"1{Environment.NewLine}2".GetPureLines());
        Assert.Equal(["1", "2"], $"1{Environment.NewLine}2{Environment.NewLine}".GetPureLines());
        Assert.Equal(["1"], $"1{Environment.NewLine} ".GetPureLines());
        Assert.Equal(["1"], $"{Environment.NewLine}1{Environment.NewLine} ".GetPureLines());
    }
