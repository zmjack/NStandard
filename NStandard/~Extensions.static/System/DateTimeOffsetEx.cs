...
public static class DateTimeOffsetEx
{
    ...
    /// <para>Please use <see cref="FromWeekOfYear(int, int, TimeSpan, CalendarWeekRule, DayOfWeek)"/> instead.</para>
    /// </summary>
    ...
    /// <returns></returns>
    [Obsolete("Use FromWeek(year, week, offset, CalendarWeekRule.FirstFullWeek, firstDayOfWeek) instead.", true)]
    ...
    /// <summary>
    /// Gets a DateTimeOffset for the specified iso-week of year.
    /// </summary>
    /// <param name="pair"></param>
    /// <param name="offset"></param>
    /// <returns></returns>
    public static DateTimeOffset FromWeekOfYear(YearWeekPair pair, TimeSpan offset)
    {
        return FromWeekOfYear(pair.Year, pair.Week, offset, CalendarWeekRule.FirstFourDayWeek, DayOfWeek.Monday);
    }
    /// <summary>
    /// Gets a DateTimeOffset for the specified week of year.
    /// </summary>
    ...
    /// <returns></returns>
    public static DateTimeOffset FromWeekOfYear(YearWeekPair pair, TimeSpan offset, CalendarWeekRule rule, DayOfWeek firstDayOfWeek)
    {
        return FromWeekOfYear(pair.Year, pair.Week, offset, rule, firstDayOfWeek);
    }
    ...
    /// <param name="offset"></param>
    /// <returns></returns>
    public static DateTimeOffset FromWeekOfYear(int year, int week, TimeSpan offset)
    {
        return FromWeekOfYear(year, week, offset, CalendarWeekRule.FirstFourDayWeek, DayOfWeek.Monday);
    }
    /// <summary>
    /// Gets a DateTimeOffset for the specified week of year.
    /// </summary>
    ...
    /// <param name="firstDayOfWeek"></param>
    /// <returns></returns>
    public static DateTimeOffset FromWeekOfYear(int year, int week, TimeSpan offset, CalendarWeekRule rule, DayOfWeek firstDayOfWeek)
    {
        var firstDayOfYear = new DateTimeOffset(year, 1, 1, 0, 0, 0, offset);
